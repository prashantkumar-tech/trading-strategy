...
Universe: all NYSE + NASDAQ common stocks above a market-cap floor (default
$2B, adjustable in the sidebar) — includes the entire S&P 500 plus a much
wider mid/smaller-cap field. Benchmark is SPY so results line up against the
S&P 500 page.
"""
